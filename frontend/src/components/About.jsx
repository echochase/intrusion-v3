  ...
  return (
    <div className="about-description">
      ...
      <ul className="stages-list">
        ...
        <li>The Hacker secretly draws two cards from any mix of the Security and Hacker decks, then discards one before submitting.</li>
        <li>Each player submits one card or passes. The System resolves the queue and produces an incident report.</li>
        <li>Defences are face-up, persistent, and limited to three active lanes at a time.</li>
        <li>Tasks give project progress. Tasks in defended lanes are worth more.</li>
      </ul>
      ...
      <p>
        ...
        complete tasks, or draw from the Security deck when they need to look normal. Helpful behaviour is
      ...
      <p>
        ...
        important decisions: defend lanes, complete project work, watch for suspicious behaviour, and time
