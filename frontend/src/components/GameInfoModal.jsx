            ...
            <div className="rules-copy">
              ...
              <RuleBlock title="Players and Roles">
                <RulesList>
                  ...
                  <p><strong>The Hacker</strong> wins by reducing System Integrity to zero. At the start of each turn after the first, the Hacker secretly draws 2 cards in any combination from the Security and Hacker decks, then discards 1 card.</p>
                </RulesList>
              </RuleBlock>
              ...
              <RuleBlock title="Lanes, Defences, and Tasks">
                <RulesList>
                  ...
                  <p>Tasks belong to lanes. A task gives +1 project progress, or +2 if its lane is currently defended.</p>
                </RulesList>
              </RuleBlock>
